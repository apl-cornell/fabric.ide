...
public class FabricParseController extends ParseControllerBase {

	private PolyglotNodeLocator fSourcePositionLocator;

	public FabricParseController(String languageID) {
		super(languageID);
	}
	...
	public ISourcePositionLocator getSourcePositionLocator() {
		if (fSourcePositionLocator == null) {
			Object lexStream = null;
			fSourcePositionLocator = new PolyglotNodeLocator(fProject, lexStream);
		}
	...
	public ILanguageSyntaxProperties getSyntaxProperties() {
		return new FabricSyntaxProperties();
	}
...
//            	source = fCompiler.getExtInfo().extFileManager().fileSource(file.getAbsolutePath(), true);
//            }
//
//            List<FileSource> streams= Arrays.asList(source);
...
//     */
//	private FileSource buildJarFileEntrySource(final String contents, int jarPathComponentIdx) throws ZipException, IOException {
//		FileSource source;
